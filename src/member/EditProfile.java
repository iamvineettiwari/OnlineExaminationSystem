                ...
                out.println("<!DOCTYPE html>" +
                            ...
                            "<div class=\"container-fluid user-edit-profile-main\">"
                                +"<div class=\"col-md-6 offset-md-3 user-edit-profile-wrap\">"
                                    ...
                                    "<input type=\"text\" name=fname value=\""+db.rst.getString(3)+"\"  class=\"form-control\">" +
                                    "</div>" +
                                    "</div>" +
                                    "<div class=\"form-group\">" +
                                    "<label>Email</label>" +
                                    "<input type=\"email\" name=email value=\""+db.rst.getString(4)+"\"  class=\"form-control\">" +
                                    "</div>" +
                                    "<div class=\"form-row\">" +
                                    "<div class=\"form-group col-md-6\">" +
                                    "<label>Gender</label>" +
                            ...
                            if (db.rst.getString(5).equalsIgnoreCase("male")) {
                                    ...
                                    "<input type=\"date\" name=dob value=\""+db.rst.getString(7)+"\"  class=\"form-control\">"+
                                    "</div>" +
                                    "<div class=\"form-group col-md-12\">" +
                                    "<label>Qualification</label>" +
                                    "<select class=\"form-control\" name=\"qual\">");
                                    
                                    if (db.rst.getString(8).equalsIgnoreCase("10")) {
                                    ...
                                    } else if (db.rst.getString(8).equalsIgnoreCase("12")) {
                                        ...
                                        "<option value=\"MCA\">MCA</option>"+
                                        "<option value=\"M.Tech.\">M.Tech.</option>");
                                    } else if (db.rst.getString(8).equalsIgnoreCase("B.Sc.")) {
                                        out.println("<option value=\"10\">10 (Matriculation)</option>"+
                                        "<option value=\"12\">10+2 (Intermediate)</option>"+
                                        ...
                                        "<option value=\"MCA\">MCA</option>"+
                                        "<option value=\"M.Tech.\">M.Tech.</option>");
                                    }  else if (db.rst.getString(8).equalsIgnoreCase("BCA")) {
                                        out.println("<option value=\"10\">10 (Matriculation)</option>"+
                                        "<option value=\"12\">10+2 (Intermediate)</option>"+
                                        "<option value=\"B.Sc.\">B.Sc.</option>"+
                                        ...
                                        "<option value=\"MCA\">MCA</option>"+
                                        "<option value=\"M.Tech.\">M.Tech.</option>");
                                    }   else if (db.rst.getString(8).equalsIgnoreCase("B.Tech.")) {
                                        out.println("<option value=\"10\">10 (Matriculation)</option>"+
                                        "<option value=\"12\">10+2 (Intermediate)</option>"+
                                        "<option value=\"B.Sc.\">B.Sc.</option>"+
                                        "<option value=\"BCA\">BCA</option>"+
                                        ...
                                        "<option value=\"MCA\">MCA</option>"+
                                        "<option value=\"M.Tech.\">M.Tech.</option>");
                                    }   else if (db.rst.getString(8).equalsIgnoreCase("M.Sc.")) {
                                        out.println("<option value=\"10\">10 (Matriculation)</option>"+
                                        "<option value=\"12\">10+2 (Intermediate)</option>"+
                                        "<option value=\"B.Sc.\">B.Sc.</option>"+
                                        "<option value=\"BCA\">BCA</option>"+
                                        ...
                                        "<option value=\"MCA\">MCA</option>"+
                                        "<option value=\"M.Tech.\">M.Tech.</option>");
                                    }   else if (db.rst.getString(8).equalsIgnoreCase("MCA")) {
                                        out.println("<option value=\"10\">10 (Matriculation)</option>"+
                                        "<option value=\"12\">10+2 (Intermediate)</option>"+
                                        "<option value=\"B.Sc.\">B.Sc.</option>"+
                                        "<option value=\"BCA\">BCA</option>"+
                                        ...
                                        "<option value=\"M.Tech.\">M.Tech.</option>");
                                    }   else if (db.rst.getString(8).equalsIgnoreCase("M.Tech.")) {
                                        out.println("<option value=\"10\">10 (Matriculation)</option>"+
                                        "<option value=\"12\">10+2 (Intermediate)</option>"+
                                        "<option value=\"B.Sc.\">B.Sc.</option>"+
                                        "<option value=\"BCA\">BCA</option>"+
                                    ...
                                    "<div class=\"form-group col-md-12\">" +
                                    "<label>Address</label>" +
                                    "<textarea name=address class=\"form-control\">"+db.rst.getString(9)+"</textarea>" +
                                    "</div>" +
                                    "<div class=\"form-group col-md-6\">"+
                                    "<label>City</label>"+
                                    "<input type=\"text\" name=city value=\""+db.rst.getString(10)+"\"  class=\"form-control\">" +
                                    "</div>" +
                                    "<div class=\"form-group col-md-6\">"+
                                    "<label>Contact</label>"+
                                    "<input type=\"number\" name=contact value=\""+db.rst.getString(11)+"\"  class=\"form-control\">" +
                                    "</div>" +
