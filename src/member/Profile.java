            ...
            if (session.getAttribute("usertype") != null && session.getAttribute("usertype").equals("member")) {
                ...
                out.println("<!DOCTYPE html>" +
                            ...
                            "<div class=\"container-fluid user-profile-main\">"
                                ...
                                +"</div>"
                                +"<h4 class=\"user-profile-name-head text-center\">"+db.rst.getString(2).toUpperCase()+"</h4>"
                                +"<div class=\"row\">"
                                    +"<div class=\"col-md-4\">"
                                    ...
                                    +"<div class=\"col-md-4\">"
                                        ...
                                        + "<p class=\"user-prof-cont-content prof-cont-caps\">"+db.rst.getString(3)+"</p>"
                                        + "</div>"
                                    + "</div>"
                                    +"<div class=\"col-md-4\">"
                                        + "<div class=\"user-prof-cont-main col-md-12\">"
                                        + "<h3 class=\"user-prof-cont-head\">Email</h3>"
                                        + "<p class=\"user-prof-cont-content\">"+db.rst.getString(4)+"</p>"
                                        + "</div>"
                                    + "</div>"
                                + "</div>"
                                +"<div class=\"row\">"
                                    +"<div class=\"col-md-4\">"
                                        ...
                                        + "<p class=\"user-prof-cont-content prof-cont-caps\">"+db.rst.getString(5)+"</p>"
                                        + "</div>"
                                    + "</div>"
                                    +"<div class=\"col-md-4\">"
                                        + "<div class=\"user-prof-cont-main col-md-12\">"
